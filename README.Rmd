...
This is the recommended way to use this method. The HMFGraph_GEM function selects an optimal alpha value based on a condition number constraint method (if the alpha is not specified in the function call). HMFGraph_GEM_permutations calculates the null network (or null distribution) and HMFGraph_GEM_optimal_CI selects the optimal credible interval (CI) based on the permutations.
